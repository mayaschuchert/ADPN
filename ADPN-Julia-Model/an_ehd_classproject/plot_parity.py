"""
plot_parity.py — parity plot for the published kinetics fit.

Input:  output/data/parity.csv
Output: output/plots/parity_combined.png
"""
import os
import numpy as np
import pandas as pd
...
CSV = os.path.join(DATA_DIR, "parity.csv")
...
def main():
    ...
    fig.suptitle("Published kinetics fit — model vs experiment",
                 y=1.06, fontsize=12)
    fig.tight_layout()

    out = os.path.join(PLOT_DIR, "parity_combined.png")
