...
# v7 §21-§22 additions: continuation solver + Lees S1.11 sequential fitter
include("galv_continuation.jl")
include("fit_kinetics_seq.jl")
...
export Params, Mesh, Diffusivity, Chemistry, Kinetics, Transport, Assembly, Solver,
       ...
       # v7 §21-§22 — continuation solver + sequential fit
       solve_at_j_cont, ContResult,
       SeqFitState, SeqFitState_from_v3, run_sequential_fit, branch_residuals!
